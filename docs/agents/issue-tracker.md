...
- **`frontend`** — Strapi Admin UI, custom admin, browser-side upload/preview, and other client-facing work. Apply alongside the triage state/category labels; do not use it as a substitute for them.
